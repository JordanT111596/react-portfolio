            ...
            <div className="row w-auto">
                ...
                <div className="col-md-9 mt-5 card">
                    <div className="card-body">
                        ...
                        <Project name="Eat-Da-Burger!" deployLink="https://warm-bayou-69464.herokuapp.com" image={eatDaBurgerDemo} alt="Demo Gif for Eat-Da-Burger" repoLink="https://github.com/JordanT111596/Node-Express-Handlebars" />
