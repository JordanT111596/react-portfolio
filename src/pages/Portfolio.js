            ...
            <div className="row w-auto">
                ...
                <div className="col-md-9 mt-5 card">
                    <div className="card-body">
                        ...
                        Pusher Notifications (WebSockets), MySQL Migrations, Node.js, Express.js, Passport (Authentication)" />
                        ...
                        <Project name="Pandemic Playlist"
                            ...
                            tech="Bootstrap CSS, Passport (Authentication), MySQL & Sequelize, Express.js, Node.js, The Movie DB API" />
